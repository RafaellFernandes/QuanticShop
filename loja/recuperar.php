                         ...
                         <div class="card-body text-center">
                              <?php
                                   ...
                                   if($sql->rowCount() == 1){
                                        ...
                                        $url = 'http://localhost//QuanticShop/loja/redefinir.php';

                                        $corpo = 'Olá '.$info['primeiro_nome'].', <br>
                                        Foi solicitada uma redefinição da sua senha na QuanticShop. Acesse o link abaixo para redefinir sua senha.<br>
