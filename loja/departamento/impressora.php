...
<div class="latest-products">
    <div class="container">
        <div class="row">
            ...
            <?php
				$sql = "SELECT * FROM produto WHERE ativo = 1 AND departamento_id IN (12)";
            ...
            <div class='col-md-4'>
                <div class='product-item'>
                    <a href='pages/produto/<?=$id?>'><img src='../fotos/produtos/<?=$imagem[0]?>' align='right' class="img" alt='<?=$nome_produto?>' title='Produto: <?=$nome_produto?>'></a>
